...
(
    NAME = 'FirstFG_Data',
    FILENAME = 'D:\ITI\Projects\SQL\FirstFG_Data.ndf',
    SIZE = 50MB,
    MAXSIZE = 500MB,
    FILEGROWTH = 10MB
...
(
    NAME = 'SecondFG_Data',
    FILENAME = 'D:\ITI\Projects\SQL\SecondFG_Data.ndf',
    SIZE = 50MB,
    MAXSIZE = 500MB,
    FILEGROWTH = 10MB
...
(
    NAME = 'ThirdFG_Data',
    FILENAME = 'D:\ITI\Projects\SQL\ThirdFG_Data.ndf',
    SIZE = 50MB,
    MAXSIZE = 500MB,
    FILEGROWTH = 10MB
...
(
    NAME = 'ForthFG_Data',
    FILENAME = 'D:\ITI\Projects\SQL\ForthFG_Data.ndf',
    SIZE = 50MB,
    MAXSIZE = 500MB,
    FILEGROWTH = 10MB
...
CREATE NONCLUSTERED INDEX IX_Branches ON Branches(City)
-- Intake Table  
...
CREATE NONCLUSTERED INDEX IX_Intakes ON Intakes(Intake_Name)
-- Department Table 
...
(
 ...
 CREATE NONCLUSTERED INDEX IX_Departments ON Departments(Department_Name)
-- Track Table
create table Tracks
(
  ...
  CREATE NONCLUSTERED INDEX IX_Tracks ON Tracks(Track_Name)
-- Student Table
...
(
 ...
 CREATE NONCLUSTERED INDEX IX_Students ON Students(Student_Name)
...
CREATE NONCLUSTERED INDEX IX_Instructors ON Instructors(Instructor_Name)
-- Course Table
...
CREATE NONCLUSTERED INDEX IX_Courses ON Courses(Course_Name)
...
CREATE NONCLUSTERED INDEX IX_Exams ON Exams(Exam_Date)
...
CREATE NONCLUSTERED INDEX IX_TF ON TF(Question_Name)
-- Text Question Table
...
CREATE NONCLUSTERED INDEX IX_Text_Question ON Text_Question(Question_Name)
-- Choose Table
...
CREATE NONCLUSTERED INDEX IX_Multiple_Choose ON Multiple_Choose(Question_Name)